	...
	<div class="prefix_2 grid_4">
    	<fieldset>
            ...
            <form action="actualizar.php" method="post">
				...
				<?php echo campos("Visible Palabra","visible","select",array("1"=>"si","0"=>"no"),0,"",$datos['Visible']);?>
				<?php echo campos("Visible Relación","visiblerelacion","select",array("1"=>"si","0"=>"no"),0,"",$datos['VisibleRelacion']);?>
                        </td>
					</tr>
                    <tr>
                    	<td>
